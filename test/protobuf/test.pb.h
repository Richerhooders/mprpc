...
namespace fixbug {
class GetFriendListsReponse;
struct GetFriendListsReponseDefaultTypeInternal;
extern GetFriendListsReponseDefaultTypeInternal _GetFriendListsReponse_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendListsReponse* Arena::CreateMaybeMessage<::fixbug::GetFriendListsReponse>(Arena*);
...
class GetFriendListsReponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsReponse) */ {
 public:
  inline GetFriendListsReponse() : GetFriendListsReponse(nullptr) {}
  ~GetFriendListsReponse() override;
  explicit PROTOBUF_CONSTEXPR GetFriendListsReponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetFriendListsReponse(const GetFriendListsReponse& from);
  GetFriendListsReponse(GetFriendListsReponse&& from) noexcept
    : GetFriendListsReponse() {
    *this = ::std::move(from);
  }

  inline GetFriendListsReponse& operator=(const GetFriendListsReponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsReponse& operator=(GetFriendListsReponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetFriendListsReponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetFriendListsReponse* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsReponse*>(
               &_GetFriendListsReponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendListsReponse& a, GetFriendListsReponse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsReponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetFriendListsReponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetFriendListsReponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetFriendListsReponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetFriendListsReponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const GetFriendListsReponse& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsReponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsReponse";
  }
  protected:
  explicit GetFriendListsReponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsReponse)
 private:
  class _Internal;
...
class UserServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::fixbug::GetFriendListsReponse* response,
                       ::google::protobuf::Closure* done);
...
// .fixbug.Resultcode result = 1;
inline bool GetFriendListsReponse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListsReponse::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsReponse::clear_result() {
  if (GetArenaForAllocation() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::Resultcode& GetFriendListsReponse::_internal_result() const {
  const ::fixbug::Resultcode* p = result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::Resultcode&>(
      ::fixbug::_Resultcode_default_instance_);
}
inline const ::fixbug::Resultcode& GetFriendListsReponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsReponse.result)
  return _internal_result();
}
inline void GetFriendListsReponse::unsafe_arena_set_allocated_result(
    ::fixbug::Resultcode* result) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(result_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListsReponse.result)
}
inline ::fixbug::Resultcode* GetFriendListsReponse::release_result() {
...
inline ::fixbug::Resultcode* GetFriendListsReponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsReponse.result)
  
  ::fixbug::Resultcode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::Resultcode* GetFriendListsReponse::_internal_mutable_result() {
...
inline ::fixbug::Resultcode* GetFriendListsReponse::mutable_result() {
  ::fixbug::Resultcode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsReponse.result)
  return _msg;
}
inline void GetFriendListsReponse::set_allocated_result(::fixbug::Resultcode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsReponse.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetFriendListsReponse::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriendListsReponse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendListsReponse::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriendListsReponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsReponse.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsReponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsReponse.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriendListsReponse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsReponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsReponse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendListsReponse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriendListsReponse::add_friend_list() {
  ::fixbug::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsReponse.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsReponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsReponse.friend_list)
  return friend_list_;
}
