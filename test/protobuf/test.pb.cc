...
PROTOBUF_CONSTEXPR GetFriendListsReponse::GetFriendListsReponse(
    ::_pbi::ConstantInitialized)
  : friend_list_()
  , result_(nullptr){}
struct GetFriendListsReponseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR GetFriendListsReponseDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~GetFriendListsReponseDefaultTypeInternal() {}
  union {
    GetFriendListsReponse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GetFriendListsReponseDefaultTypeInternal _GetFriendListsReponse_default_instance_;
}  // namespace fixbug
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsReponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsReponse, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsReponse, friend_list_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 40, -1, -1, sizeof(::fixbug::GetFriendListsReponse)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::fixbug::_GetFriendListsReponse_default_instance_._instance,
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ListsRequest\032\035.fixbug.GetFriendListsRepo"
...
class GetFriendListsReponse::_Internal {
 public:
  static const ::fixbug::Resultcode& result(const GetFriendListsReponse* msg);
};

const ::fixbug::Resultcode&
GetFriendListsReponse::_Internal::result(const GetFriendListsReponse* msg) {
  return *msg->result_;
}
GetFriendListsReponse::GetFriendListsReponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned),
  friend_list_(arena) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendListsReponse)
}
GetFriendListsReponse::GetFriendListsReponse(const GetFriendListsReponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListsReponse)
}

inline void GetFriendListsReponse::SharedCtor() {
result_ = nullptr;
}

GetFriendListsReponse::~GetFriendListsReponse() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListsReponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void GetFriendListsReponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListsReponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void GetFriendListsReponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListsReponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListsReponse::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* GetFriendListsReponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListsReponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListsReponse)
  return target;
}

size_t GetFriendListsReponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsReponse)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData GetFriendListsReponse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    GetFriendListsReponse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*GetFriendListsReponse::GetClassData() const { return &_class_data_; }

void GetFriendListsReponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<GetFriendListsReponse *>(to)->MergeFrom(
      static_cast<const GetFriendListsReponse &>(from));
}


void GetFriendListsReponse::MergeFrom(const GetFriendListsReponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsReponse)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListsReponse::CopyFrom(const GetFriendListsReponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListsReponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListsReponse::IsInitialized() const {
  return true;
}

void GetFriendListsReponse::InternalSwap(GetFriendListsReponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListsReponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_test_2eproto_getter, &descriptor_table_test_2eproto_once,
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListsReponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendListsReponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsReponse*
Arena::CreateMaybeMessage< ::fixbug::GetFriendListsReponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendListsReponse >(arena);
}
